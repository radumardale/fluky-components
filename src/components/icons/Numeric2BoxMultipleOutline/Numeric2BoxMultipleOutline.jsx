...
/** Numeric2BoxMultipleOutline icon */
const Numeric2BoxMultipleOutline = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
    <title id="title">Numeric2BoxMultipleOutline</title>
...
export default wrapInTheme(Numeric2BoxMultipleOutline);
